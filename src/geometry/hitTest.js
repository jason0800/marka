...
/**
 * Finds the topmost shape at a given point from a list of shapes.
 * Iterates in reverse to find the one "on top" visually.
 */
export const findShapeAtPoint = (point, shapes, tolerance = 5) => {
